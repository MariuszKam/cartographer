...
1000+ test suite on the Windows CI runner, with the slowest class around a few
...
- at least 1000 tests must execute;
...
The current target state is 1000+ tests executing deterministically in the
